...
// Configuración exacta de tu aplicación web en Firebase
...
// Patrón Singleton para evitar inicializar Firebase múltiples veces en Next.js (SSR)
// Si ya existe una app inicializada, la obtenemos, si no, la creamos con tu configuración.
