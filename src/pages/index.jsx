...
// --- CONFIGURACIÓN DE FIREBASE (Inyectada directamente para evitar errores de resolución) ---
...
// Identificadores fijos para la versión dedicada de Dulce Sal
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Ruta segura para Firestore siguiendo las reglas del sandbox
  ...
  const handleSetup = async (e) => {
    ...
    try {
      ...
      try {
        ...
        // Si falla (ej. ya existe), intentamos loguear
        try {
